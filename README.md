...
Airfoil Tools is a local desktop app for designing, previewing, and exporting 4-digit NACA airfoils without bouncing between calculators, scripts, CAD cleanup, and heavyweight solver workflows.
...
Airfoil Tools compresses that workflow into one local app. You can edit the profile directly from the GUI, move sliders, see the section update in real time, and watch the quick aerodynamic estimate react while changing parameters such as chord, span, rotation, mirroring, camber, and thickness.
...
One of the main workflow advantages of Airfoil Tools is that export is not an afterthought.
...
Airfoil Tools is strongest when you already know you want a 4-digit NACA section and need the shortest path from idea to usable geometry.
